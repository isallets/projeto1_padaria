...
const PORT = (_a = process.env.PORT) !== null && _a !== void 0 ? _a : 5900;
...
////
app.post("/api/venda", ProductController_3.adicionaVenda);
app.get("/api/venda", ProductController_3.buscaVenda);
